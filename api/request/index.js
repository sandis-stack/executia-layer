...
function mailTemplate(title, lines, body, action) {
  const rows = lines
  ...
  const actionHtml =
    action?.url
      ? `<div style="margin-top:28px"><a href="${esc(action.url)}" style="display:inline-block;background:#0f2d4a;color:#ffffff;text-decoration:none;padding:14px 22px;font-size:13px;letter-spacing:1.5px;font-weight:700">OPEN GOVERNANCE REVIEW</a></div>`
      : "";
