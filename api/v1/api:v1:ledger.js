...
export default withEngine(async (req, res) => {
  ...
  if (error) return res.status(500).json({ ok: false, error_code: "LEDGER_FETCH_FAILED", error_message: error.message, request_id: req.executia.requestId });
